...
internal class GenerateRandomDataTest() : UsefulTestCase() {
  ...
  private val avroSchema1 = "{\"type\":\"record\",\"name\":\"options_test_record\",\"fields\":[{\"name\":\"array_field\",\"type\":" +
  ...
  private val avroSchema2 = "{\"type\":\"record\",\"name\":\"sampleRecordTwo\",\"namespace\":\"com.mycorp.mynamespace\",\"doc\":" +
