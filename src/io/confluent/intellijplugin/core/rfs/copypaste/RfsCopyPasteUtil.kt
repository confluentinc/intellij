...
import io.confluent.intellijplugin.core.rfs.driver.copyhandler.InterDriverCopyHandler
...
object RfsCopyPasteUtil {
    fun getCorrectTargetPath(
        ...
        val pathFromHandlers = InterDriverCopyHandler.getCorrectTargetPath(
            fromInfo, toParentPath, toDriver,
            exportFormat
        )
    ...
    internal fun getFileInfoFromVirtualFiles(uploadingFiles: List<VirtualFile>): List<FileInfo> =
        uploadingFiles.mapNotNull { vFile ->
