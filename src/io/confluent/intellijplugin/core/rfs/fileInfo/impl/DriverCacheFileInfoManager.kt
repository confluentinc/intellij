...
class DriverCacheFileInfoManager(
  ...
  private val cacheRfsNodeChildren: Cache<RfsChildrenPartId, SafeResult<RfsFileInfoChildren>> = CacheBuilder.newBuilder()
  ...
  override fun getCachedChildrenInner(rfsPath: RfsPath): SafeResult<RfsFileInfoChildren>? = cacheRfsNodeChildren.getIfPresent(RfsChildrenPartId(rfsPath))
  ...
  private fun updateWaitingPaths(rfsPath: RfsPath,
  ...
  private fun processSuccessChildrenLoad(rfsPath: RfsPath,
  ...
  private fun invalidateChildren(rfsPath: RfsPath, propagate: Boolean,
  ...
  private fun filterChildren(rfsPath: RfsPath,
                             propagate: Boolean,
                             includeItself: Boolean,
                             excludeStartWith: List<RfsPath>): List<RfsChildrenPartId> {
  ...
  private fun filterNodes(rfsPath: RfsPath,
                          propagate: Boolean,
                          includeItself: Boolean,
                          excludeStartWith: List<RfsPath>): List<RfsPath> {
...
private fun <K: Any, K1: K, V1> CacheBuilder<K, Any>.buildDeferred(scope: CoroutineScope, load: suspend (K1) -> V1): SuspendingLoadingCacheWrapper<K1, V1> {
