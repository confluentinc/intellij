...
abstract class RfsProjectPaneActionBase : DumbAwareAction {
  constructor() : super()
  constructor(@NlsActions.ActionText text: String, @NlsActions.ActionDescription description: String? = null, icon: Icon? = null) :
  ...
  companion object {
    ...
    fun getMountNodes(pane: RfsPaneOwner) = pane.getSelectionPaths().map { it.lastPathComponent as? RfsTreeNode }.filter { it?.isMount == true }
  }
}