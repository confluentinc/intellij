package io.confluent.intellijplugin.core.rfs.projectview
...
class RfsPanelDoubleClickListener private constructor(
    ...
    companion object {
        ...
        fun installOn(
            project: Project,
            tree: JTree,
            onFileDoubleClick: ((tree: JTree, node: DriverFileRfsTreeNode) -> Unit)? = null
        ): Unit =
