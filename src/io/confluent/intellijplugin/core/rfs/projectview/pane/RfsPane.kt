...
import io.confluent.intellijplugin.core.rfs.projectview.RfsPanelClickLinksListener
...
import io.confluent.intellijplugin.core.rfs.projectview.dnd.RfsPaneDnDTarget
import io.confluent.intellijplugin.core.rfs.projectview.dnd.RfsPaneDndSource
import io.confluent.intellijplugin.core.rfs.tree.CompoundRfsTreeModel
...
class RfsPane(
    ...
    private fun initAdditional() {
        ...
        myTree.emptyText.text =
            if (shortcut.isNotEmpty()) KafkaMessagesBundle.message("tree.empty.text.shortcut", shortcut)
    ...
    private fun initTree() {
        treeModel = CompoundRfsTreeModel(
            project,
            rootProvider,
            additionalDrivers,
        ...
        ClientProperty.put(
            myTree, DefaultTreeUI.AUTO_EXPAND_FILTER,
            Function { node: Any? ->
