...
import io.confluent.intellijplugin.core.rfs.copypaste.RfsCopyPasteSupport
...
import io.confluent.intellijplugin.core.rfs.search.impl.BdtConnectionSearcher
...
import io.confluent.intellijplugin.core.table.getColumnByName
import io.confluent.intellijplugin.core.table.removeColumn
import io.confluent.intellijplugin.core.table.renderers.CustomTableCellRenderer
import io.confluent.intellijplugin.core.ui.StatusTextAnimator
...
class RfsTableViewer(val project: Project, val driver: Driver, rfsPath: RfsPath, val searchField: SearchTextField) :
    Disposable {
    ...
    private val loadingAnimator = StatusTextAnimator(
        table.emptyText, listOf(
    ...
    init {
        ...
        PopupHandler.installPopupMenu(
            table,
            "BigDataTools.RfsPane.PopupActionGroup",
            RfsActionPlaces.RFS_TABLE_VIEW_POPUP
        )
        ...
        promise.onProcessed {
            ...
            invokeLater {
                ...
                results.forEach { searchElement ->
                    searchElement.icon =
                        driver.treeNodeBuilder.getNode(project, driver, searchElement.rfsPath, searchElement.fileInfo)
                            .getIdleIcon()
                }
                ...
                if (batchId == null) {
                    ...
                    if (rfsPathParent != null) {
                        dataTableModel.setData(
                            mutableListOf<ListElement>(
                                BackListElement(
                                    DummyFileInfo(
                                        name = "..",
                                        path = withSearchPath,
