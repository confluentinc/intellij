...
import io.confluent.intellijplugin.core.rfs.driver.DriverBase
import io.confluent.intellijplugin.core.rfs.driver.FileInfo
import io.confluent.intellijplugin.core.rfs.driver.RfsPath
import io.confluent.intellijplugin.core.rfs.driver.StorageDriver
import io.confluent.intellijplugin.core.rfs.driver.local.node.LocalRfsDriverTreeNodeBuilder
import io.confluent.intellijplugin.core.rfs.exception.RfsPermissionException
...
import io.confluent.intellijplugin.core.rfs.util.withSlash
...
class LocalDriver(
    ...
    companion object {
        private fun extractFullPath(connectionData: RfsLocalConnectionData, project: Project?): String {
            ...
            val rootFile =
                File(if (path.startsWith(".") || path.isEmpty()) "${project?.basePath ?: ""}/$path" else path)
