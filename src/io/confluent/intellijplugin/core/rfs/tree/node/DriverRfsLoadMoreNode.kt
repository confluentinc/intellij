...
class DriverRfsLoadingNode(
  ...
  override fun update(presentation: PresentationData) {
    presentation.addText(ColoredFragment(KafkaMessagesBundle.message ("tree.action.label.loading"), SimpleTextAttributes.GRAY_ATTRIBUTES))
  }
}
...
class DriverRfsLoadMoreNode(
  ...
  override fun update(presentation: PresentationData) {
    presentation.addText(ColoredFragment(KafkaMessagesBundle.message ("tree.action.label.load.more"), SimpleTextAttributes.LINK_ATTRIBUTES))
    presentation.addText(ColoredFragment(" ".repeat(4), SimpleTextAttributes.REGULAR_ATTRIBUTES))
    presentation.addText(ColoredFragment(KafkaMessagesBundle.message("tree.action.label.open.in.editor"), SimpleTextAttributes.LINK_ATTRIBUTES))
  }
