...
open class BdtConnectionException(
    open val shortDescription: @Nls String = KafkaMessagesBundle.message("connection.error.exception"),
...
class BdtKerberosException(
    cause: Throwable?,
    override val shortDescription: String = cause?.message ?: "Kerberos Error",
    override val additionalNotification: String
) : BdtSpecificConnectionException(cause)
