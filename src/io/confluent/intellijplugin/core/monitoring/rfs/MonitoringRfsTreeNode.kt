...
import io.confluent.intellijplugin.core.rfs.tree.node.CustomDoubleClickable
import io.confluent.intellijplugin.core.rfs.tree.node.DriverFileRfsTreeNode

open class MonitoringRfsTreeNode(
    project: Project, rfsPath: RfsPath,
    final override val driver: MonitoringDriver
) : DriverFileRfsTreeNode(project, rfsPath, driver),
