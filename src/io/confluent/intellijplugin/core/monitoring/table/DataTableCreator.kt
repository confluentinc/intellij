...
object DataTableCreator {
    ...
    fun <T : RemoteInfo> create(
        tableModel: DataTableModel<T>,
        extensions: EnumSet<TableExtensionType> = EnumSet.noneOf(TableExtensionType::class.java)
    ): DataTable<T> {
        ...
        extensions.forEach { extension: TableExtensionType ->
            when (extension) {
                ...
                TableExtensionType.MULTI_SELECT -> table.selectionModel.selectionMode =
