...
class TableColumnsFitter<T : RemoteInfo> private constructor(
    ...
    companion object {
        ...
        fun get(table: DataTable<*>): TableColumnsFitter<*>? = table.tableModel.getFirstListenerOfClass(
            TableColumnsFitter::class.java
        ) as? TableColumnsFitter<*>
    }
