...
import io.confluent.intellijplugin.core.table.renderers.MouseListeningRenderer
import javax.swing.table.TableCellRenderer

class TableRenderersSetter private constructor(
    ...
    init {
        ...
        if (columnModel != null && tableModel != null) {
            columnModel.allColumns.withIndex().forEach { column ->
                ...
                val renderer = customRendererSupplier?.invoke(annotations, tableModel) ?: DataRenderingUtil.getRenderer(
                    annotations,
                    tableModel
                )
