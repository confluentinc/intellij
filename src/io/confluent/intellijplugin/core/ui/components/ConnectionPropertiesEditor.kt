...
class ConnectionPropertiesEditor(project: Project, private val variants: List<ConnectionProperty>) {
    ...
    private val completionProvider =
        object : ValuesCompletionProvider.ValuesCompletionProviderDumbAware<ConnectionProperty>(
            descriptor,
            separators,
            variants,
            true
            ...
            override fun getAdvertisement(): String? {
                ...
                val activeLookup =
                    LookupManager.getActiveLookup(fieldWithCompletion.editor) as? LookupImpl ?: return null
    ...
    inner class AdvertiserLayout(private val advertiser: LookupImpl, private val component: Component) : LayoutManager {
        ...
        override fun preferredLayoutSize(parent: Container): Dimension {
            ...
            return Dimension(
                max(advertiser.list.preferredSize.width, 300),
                component.preferredSize.height + insets.top + insets.bottom
            )
        }
        ...
        override fun layoutContainer(parent: Container) {
            ...
            component.setBounds(
                insets.left, insets.top, JBUIScale.scale(size.width) - insets.left - insets.right,
