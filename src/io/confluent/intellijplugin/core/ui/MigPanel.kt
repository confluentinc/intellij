...
open class MigPanel(layoutConstraints: LC = UiUtil.insets0FillXHidemode3) : JPanel(MigLayout(layoutConstraints)), UserDataHolder {
  ...
  fun block(component: Component) = add(component, if (gapLeft) UiUtil.gapLeftGrowXSpanXWrap else UiUtil.growXSpanXWrap)
}