...
open class MaterialTableCellRenderer : JComponent(), TableCellRenderer {
    ...
    override fun getPreferredSize(): Dimension {
        ...
        return Dimension(
            geStringWidthLimited(fontMetrics, text) + textLeftOffset * 2,
        ...
        try {
            ...
            if (aaHint != null) {
                ...
                configureHint(
                    ...
                    g2,
                    label.getClientProperty(RenderingHints.KEY_FRACTIONALMETRICS)
                )
                configureHint(
                    RenderingHints.KEY_TEXT_LCD_CONTRAST,
                    g2,
                    label.getClientProperty(RenderingHints.KEY_TEXT_LCD_CONTRAST)
                )
            }
            ...
            if (horizontalAlignment == SwingConstants.RIGHT && !lastColumn) {
                g2.drawString(
                    getTrimmedToWidthText(fontMetrics, text, width - textLeftOffset),
