...
class LoadingChooserComponent<D : ConnectionData>(prop: KMutableProperty1<D, String?>,
                                                  key: ModificationKey,
                                                  initSettings: D,
                                                  emptyText: String,
                                                  coroutineScope: CoroutineScope,
                                                  isEditable: Boolean = false,
                                                  chooseListener: suspend CoroutineScope.() -> String?) : WrappedTextComponent<D, String?>(prop, key) {
