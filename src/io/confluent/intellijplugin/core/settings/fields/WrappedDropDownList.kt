...
class WrappedDropDownList<D : ConnectionData, E : RenderableEntity>(
    private val prop: KMutableProperty1<D, String>,
    values: Array<E>,
    key: ModificationKey,
    initSettings: D,
    private val defaultValue: E? = null,
    render: ListCellRenderer<E>? = null
    ...
    override fun getValue(): E? =
        comboBox.item ?: if (comboBox.itemCount > 0) comboBox.getItemAt(0) as E else defaultValue
