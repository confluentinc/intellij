...
object StandaloneCreateConnectionUtil {
    ...
    private fun dfsActions(
        root: DefaultActionGroup,
        groupsGraph: MultiMap<String?, ConnectionGroup>,
        project: Project
    ) {
        ...
        fun dfs(currentRoot: DefaultActionGroup, currentGroup: ConnectionGroup) {
            ...
            if (currentGroup is ConnectionFactory<*>) currentRoot.add(
                StandaloneCreateConnectionAction(
                    project,
                    currentGroup
                )
            )
