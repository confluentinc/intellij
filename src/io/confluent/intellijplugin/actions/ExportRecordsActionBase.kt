...
import io.confluent.intellijplugin.consumer.editor.ConsumerEditorUtils.getTableContent
...
internal abstract class ExportRecordsActionBase : DumbAwareAction() {
    ...
    private fun getSavedFile(project: Project): VirtualFileWrapper? {
        val fileDescriptor = FileSaverDescriptor(
            ...
            withExtensionFilter(
                KafkaMessagesBundle.message("group.Kafka.ExportRecords.Actions.label"),
