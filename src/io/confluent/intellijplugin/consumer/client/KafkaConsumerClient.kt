...
class KafkaConsumerClient(
    ...
    private fun seekPartitions(
        ...
        val startFromDateSeek: Map<TopicPartition, Long?>? =
            startTime?.let { partitionOffsetsForStartDate(it, partitions, consumer) }
    ...
    private fun partitionOffsetsForStartDate(
        startTime: Long,
        partitions: List<TopicPartition>,
        consumer: KafkaConsumer<Any, Any>
