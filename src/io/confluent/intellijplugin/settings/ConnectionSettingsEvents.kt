...
object CommonSettingsKeys {
    val OPERATIONS_TIMEOUT: ModificationKey =
        ModificationKey(KafkaMessagesBundle.message("settings.operation.timeouts"))
    ...
    val ENABLE_BASIC_AUTH_KEY: ModificationKey =
        ModificationKey(KafkaMessagesBundle.message("settings.basicAuth.enabled"))
    ...
    val ENABLE_PROXY_AUTH_KEY: ModificationKey =
        ModificationKey(KafkaMessagesBundle.message("settings.proxyAuth.enabled"))
