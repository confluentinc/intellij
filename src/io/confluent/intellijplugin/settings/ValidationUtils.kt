...
import io.confluent.intellijplugin.core.ui.applyRecursively
...
fun <D : ConnectionData> WrappedTextComponent<D, *>.withValidator(
    uiDisposable: Disposable,
    validate: (String) -> @Nls String?
):
...
fun <D : ConnectionData> WrappedTextComponent<D, *>.withValidator(
    uiDisposable: Disposable,
    supplier: Supplier<ValidationInfo?>
):
        WrappedTextComponent<D, *> {
...
fun <D : ConnectionData, E : Any?> NullableComboBoxField<D, E>.withValidator(
    uiDisposable: Disposable,
    validate: (E?) -> @Nls String?
):
...
fun <D : ConnectionData> WrappedDropDownList<D, *>.withValidator(
    uiDisposable: Disposable,
...
fun <D : ConnectionData> WrappedTextComponent<D, *>.withNotEmptyValidator(
    uiDisposable: Disposable,
    componentName: String? = null
): WrappedTextComponent<D, *> =
    this.withValidator(uiDisposable, nonEmptyValidator(componentName ?: labelToName(labelComponent.text)))

fun <D : ConnectionData> WrappedDropDownList<D, *>.withNotEmptyValidator(
    uiDisposable: Disposable,
    componentName: String? = null
) =
    this.withValidator(uiDisposable, nonEmptyValidator(componentName ?: labelToName(labelComponent.text)))

fun <D : ConnectionData> UsernameNamedField<D>.withNotEmptyValidator(
    uiDisposable: Disposable,
    componentName: String? = null
): UsernameNamedField<D> =
    this.withValidator(uiDisposable, nonEmptyValidator(componentName ?: labelToName(labelComponent.text)))

fun <D : ConnectionData> UsernameSecuredField<D>.withNotEmptyValidator(
    uiDisposable: Disposable,
    componentName: String? = null
): UsernameSecuredField<D> =
    this.withValidator(uiDisposable, nonEmptyValidator(componentName ?: labelToName(labelComponent.text)))

fun <D : ConnectionData> PasswordNamedField<D>.withNotEmptyValidator(
    uiDisposable: Disposable,
    componentName: String? = null
): PasswordNamedField<D> =
    this.withValidator(uiDisposable, nonEmptyValidator(componentName ?: labelToName(labelComponent.text)))

private fun <D : ConnectionData> WrappedNamedComponent<D>.nonEmptyValidator(componentName: String?): (String) -> String? =
    { txt ->
...
fun EditorTextField.withValidator(
    uiDisposable: Disposable,
    validate: (JComponent, String) -> String?
): EditorTextField {
    val validator = buildValidator(this, { text }, validate)
    registerValidator(uiDisposable, validator, this).enableValidation()
    return this
...
fun <D : ConnectionData> WrappedTextComponent<D, *>.withProxyHostValidator(
    uiDisposable: Disposable,
...
fun <D : ConnectionData> WrappedTextComponent<D, *>.withUrlValidator(
    uiDisposable: Disposable,
...
fun JTextComponent.withEmptyOrFileExistValidator(uiDisposable: Disposable, canBeEmpty: Boolean) {
    val validator: Supplier<ValidationInfo?> = Supplier {
        when {
            !canBeEmpty && this.text.isNullOrBlank() -> ValidationInfo(
                KafkaMessagesBundle.message("validator.file.empty"),
                this
            )
...
private fun registerTextValidator(
    uiDisposable: Disposable,
    validator: Supplier<ValidationInfo?>,
