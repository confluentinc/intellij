...
object ConnectionSettings {
    ...
    fun open(project: Project, action: ((ConnectionsConfigurable) -> Unit)? = null) {
        ...
        action?.let {
            val connectionsConfigurable =
                (configurable as? ConfigurableWrapper)?.configurable as? ConnectionsConfigurable ?: return@let
