...
class ProfileCredentialProviderFactory : Disposable {
    ...
    private fun createSsoProvider(profile: Profile, profileFile: ProfileFile): AwsCredentialsProvider =
        BdtProfileSsoProvider(
            profile,
            profileFile
        )
    ...
    private fun credentialSourceCredentialProvider(
        credentialSource: BdtCredentialSourceType,
        profile: Profile
    ): AwsCredentialsProvider =
