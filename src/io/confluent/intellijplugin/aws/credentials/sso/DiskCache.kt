...
import io.confluent.intellijplugin.aws.credentials.utils.AwsJson
import io.confluent.intellijplugin.core.util.filePermissions
import io.confluent.intellijplugin.core.util.touch
import io.confluent.intellijplugin.core.util.writeText
...
class DiskCache(
    ...
    private fun clientRegistrationCache(ssoRegion: String): Path =
        cacheDir.resolve("aws-toolkit-jetbrains-client-id-$ssoRegion.json")
