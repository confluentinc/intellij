package io.confluent.intellijplugin.registry.glue

import com.intellij.openapi.Disposable
import com.intellij.openapi.project.Project
import com.intellij.openapi.util.NlsSafe
import io.confluent.intellijplugin.aws.connection.AwsConnectionUtils
import io.confluent.intellijplugin.aws.connection.auth.AwsAuthUtil
import io.confluent.intellijplugin.aws.driver.AwsCredentialController
...
class BdtGlueRegistryClient(
    val project: Project?,
    private val registryName: String,
    private val awsSettings: AwsSettingsInfo
) : Disposable {
    ...
    fun deleteSchemaVersion(schemaVersionInfo: SchemaVersionInfo) {
        ...
        val request =
            DeleteSchemaVersionsRequest.builder().schemaId(schemaId).versions(schemaVersionInfo.version.toString())
                .build()
    ...
    fun getLatestVersionInfo(schemaName: String): SchemaVersionInfo {
        ...
        return SchemaVersionInfo(
            schemaName = schemaName, version = schemaVersion,
