...
open class Presets<T : StorageConfig>(
    private val runConfig: KafkaRunConfig,
    renderer: ListCellRenderer<T>
) : ConfigChangeListener<T>, Disposable {
    ...
    val component: JPanel = ToolbarDecorator.createDecorator(presetsList)
        ...
        .addExtraAction(object :
            DumbAwareAction(KafkaMessagesBundle.message("producer.preset.apply"), null, AllIcons.Actions.Checked) {
