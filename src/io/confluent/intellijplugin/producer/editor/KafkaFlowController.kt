        ...
        collapsibleGroup(KafkaMessagesBundle.message("producer.group.flow")) {
            ...
            row {
                link(KafkaMessagesBundle.message("producer.flow.load.from.file")) {
                    ...
                    val result = FileChooser.chooseFile(
                        FileChooserDescriptorFactory.createSingleFileDescriptor(), project,
                        prevSelectedFile
                    )?.canonicalPath
                        ?: return@link
                    csvFile.set(result)
            ...
            autoParams = panel {
                ...
                groupRowsRange(
                    KafkaMessagesBundle.message("producer.flow.stop.conditions.title"),
                    indent = true,
                    topGroupGap = false
                ) {
