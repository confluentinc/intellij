...
class RunProducerConfigCellRenderer : ListCellRenderer<StorageProducerConfig> {
    ...
    override fun getListCellRendererComponent(
        list: JList<out StorageProducerConfig>,
        ...
        topicLabel.text = KafkaMessagesBundle.message(
            "producer.preset.topic", if (value?.topic.isNullOrEmpty()) KafkaMessagesBundle.message(
                "producer.preset.no.topic"
            )
            else value?.topic ?: ""
        )
        keyLabel.text = KafkaMessagesBundle.message(
            "producer.preset.key",
        ...
        valueLabel.text = KafkaMessagesBundle.message(
            "producer.preset.value",
...
class ProducerPresets :
    Presets<StorageProducerConfig>(KafkaConfigStorage.getInstance().producerConfig, RunProducerConfigCellRenderer())