...
import io.confluent.intellijplugin.util.generator.PrimitivesGenerator.generateInt
import io.confluent.intellijplugin.util.generator.PrimitivesGenerator.generateLong
...
object JsonGenerator {
    ...
    private val names = listOf(
        "Alex", "Jordan", "Taylor", "Casey", "Charlie", "Drew", "Jamie", "Jesse", "Kris", "Morgan", "Pat", "Clara",
    ...
    private val statuses = listOf(
        "Active", "Inactive", "Pending", "Approved", "Denied", "Cancelled", "Completed", "Processing", "On hold",
        "Returned"
    )
    private val tags = listOf(
        "Technology", "Sports", "Politics", "Entertainment", "Travel", "Food", "Fashion", "Education", "Health",
        "Business"
    )
