...
class JsonSchemaGenerator(private val topLevelSchema: JsonSchema) {
    ...
    private fun generateCriterionCombined(
        schema: CombinedSchema,
        criterion: CombinedSchema.ValidationCriterion
    ): JsonElement? {
    ...
    private fun generateString(schema: StringSchema): String {
        ...
        return when {
            schema.formatValidator != null && schema.formatValidator != FormatValidator.NONE -> generateFormattedString(
                schema.formatValidator
            )
    ...
    private fun generateDateTime(): String {
        ...
        val randomDateTime =
            LocalDateTime.of(randomYear, randomMonth, randomDay, randomHour, randomMinute, randomSecond)
