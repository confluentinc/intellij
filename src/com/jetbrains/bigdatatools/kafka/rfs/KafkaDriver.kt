...
import com.jetbrains.bigdatatools.core.monitoring.rfs.MonitoringDriver
import com.jetbrains.bigdatatools.core.rfs.driver.Driver
import com.jetbrains.bigdatatools.core.rfs.driver.FileInfo
...
import com.jetbrains.bigdatatools.core.rfs.tree.node.RfsDriverTreeNodeBuilder
...
class KafkaDriver(override val connectionData: KafkaConnectionData, project: Project?, testConnection: Boolean) : MonitoringDriver(project,
  ...
  override val treeNodeBuilder: RfsDriverTreeNodeBuilder = object : RfsDriverTreeNodeBuilder() {
    override fun createNode(project: Project, path: RfsPath, driver: Driver) =
      KafkaRfsTreeNode(project, path, this@KafkaDriver)
  }
