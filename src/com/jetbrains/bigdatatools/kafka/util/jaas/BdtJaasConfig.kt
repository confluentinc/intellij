 ...
 */
package com.jetbrains.bigdatatools.kafka.util.jaas
 ...
 */
class BdtJaasConfig(jaasConfigParams: String) : Configuration() {
  var configEntries: MutableList<AppConfigurationEntry> = mutableListOf()
    private set
