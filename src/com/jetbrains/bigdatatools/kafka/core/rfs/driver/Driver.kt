...
interface Driver : Disposable {
   ...
   */
  fun listStatusAsync(path: RfsPath, force: Boolean = false, startFrom: RfsListMarker? = null, resultProcessor: Processor<SafeResult<RfsFileInfoChildren>>) : CompletableFuture<*>
   ...
   */
  fun getWriteStream(rfsPath: RfsPath, overwrite: Boolean = false, canCreateNewFile: Boolean = false): SafeResult<OutputStream>
