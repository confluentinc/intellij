...
import io.confluent.kafka.core.rfs.projectview.RfsPanelDoubleClickListener
...
class RfsFileChooser(@Nls private val mainTitle: String,
                     project: Project,
                     ...
                     groups: List<ConnectionGroup> = ConnectionSettingProviderEP.getGroups()) : DialogWrapper(project, false) {

  private val rfsPane = RfsPane(project,
                                rootProvider,
                                drivers,
  ...
  override fun createCenterPanel(): JComponent {
    val toolBar = ToolbarUtils.createActionToolbar(rfsPane.tree, RfsActionPlaces.FILE_CHOOSER_TOOLBAR, descriptor.toolbarActions(), true)
