...
import io.confluent.kafka.core.monitoring.table.DataTableCreator
import io.confluent.kafka.core.monitoring.table.TableClickHelper
import io.confluent.kafka.core.monitoring.table.extension.*
import io.confluent.kafka.core.monitoring.table.extension.TableErrorHandler.Companion.CUSTOM_EMPTY_TEXT_PROVIDER
import io.confluent.kafka.core.monitoring.table.getSelectedData
...
import io.confluent.kafka.core.table.MaterialJBScrollPane
