...
enum class ConsumerStartFrom {
  NOW, LAST_HOUR, TODAY, YESTERDAY, SPECIFIC_DATE, THE_BEGINNING,
  CONSUMER_GROUP_OFFSET, LATEST_MINUS_X, OFFSET
}

enum class ConsumerLimit {
  NONE, NUMBER_OF_RECORD, DATE_MAX_SIZE, PARTITION_NUMBER_RECORDS, PARTITION_MAX_SIZE
}

enum class ConsumerFilter {
  NONE, NUMBER_OF_RECORD, DATE_MAX_SIZE, PARTITION_NUMBER_RECORDS, PARTITION_MAX_SIZE
}